...
$staff = array(
    0 => array(
        'staffid' => 1,
        'email' => 'muhammad.hassan@fantechlabs.io',
        'firstname' => 'Muhammad Hassan',
        'lastname' => 'Muhammad Nasir',
        'facebook' => '',
        'linkedin' => '',
        'phonenumber' => '',
        )
            ...
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <?php if (is_admin() || get_option('allow_non_admin_members_to_import_leads') == '1') { ?>
                        ...
                        <!-- <?php echo admin_url('leads/import'); ?> -->
                        <a href="" class="btn btn-primary pull-left display-block hidden-xs">
                            <i class="fa-solid fa-upload tw-mr-1"></i>
                            <?php echo _l('Import Sales Frontend'); ?>
                        </a>
                    <?php } ?>
                    <div class="row">
                        <div class="col-sm-5 ">
